...
```bash
git clone https://github.com/ncdai/jaydingulley.me.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [jaydingulley.me/components](https://jaydingulley.me/components) for installation instructions and component documentation.
