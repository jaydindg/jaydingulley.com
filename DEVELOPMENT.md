...
```bash
git clone https://github.com/ncdai/jaydingulley.com.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [jaydingulley.com/components](https://jaydingulley.com/components) for installation instructions and component documentation.
