...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.me/r/wheel-picker.json"
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.jaydingulley.me).
...
See the [React Wheel Picker](https://react-wheel-picker.jaydingulley.me/docs/getting-started) documentation for more information.
