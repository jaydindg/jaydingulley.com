...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/wheel-picker.json"
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.jaydingulley.com).
...
```bash
npx shadcn@latest add @jaydindg/wheel-picker
```
...
See the [React Wheel Picker](https://react-wheel-picker.jaydingulley.com/docs/getting-started) documentation for more information.
