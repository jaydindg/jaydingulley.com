...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://jaydingulley.com/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @jaydindg/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/ncdai/jaydingulley.com/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
