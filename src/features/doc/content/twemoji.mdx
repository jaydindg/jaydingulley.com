...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://jaydingulley.me/r/twemoji.json"
/>
...
[lib/twemoji-regex.ts](https://github.com/ncdai/jaydingulley.me/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
