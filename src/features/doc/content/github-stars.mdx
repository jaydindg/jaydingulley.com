...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @jaydindg/github-stars
```
...
```tsx
<GithubStars repo="ncdai/jaydingulley.com" stargazersCount={1560} />
```
