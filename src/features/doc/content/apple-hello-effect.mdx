...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/apple-hello-effect.json"
  canReplay
/>
...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/apple-hello-effect-hindi.json"
  canReplay
/>
...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/apple-hello-effect-spanish.json"
  canReplay
/>
...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/apple-hello-effect-vietnamese.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @jaydindg/apple-hello-effect
```

For Hindi:

```bash
npx shadcn@latest add @jaydindg/apple-hello-effect-hindi
```

For Spanish:

```bash
npx shadcn@latest add @jaydindg/apple-hello-effect-spanish
```

For Vietnamese:

```bash
npx shadcn@latest add @jaydindg/apple-hello-effect-vietnamese
```
