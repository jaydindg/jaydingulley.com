...
```bash
npx shadcn@latest add @jaydindg/theme-toggle-effect-circle
```

**Circle Blur**

```bash
npx shadcn@latest add @jaydindg/theme-toggle-effect-circle-blur
```

**Circle Blur (Top Left)**

```bash
npx shadcn@latest add @jaydindg/theme-toggle-effect-circle-blur-top-left
```

**Polygon**

```bash
npx shadcn@latest add @jaydindg/theme-toggle-effect-polygon
```

**Polygon Gradient**

```bash
npx shadcn@latest add @jaydindg/theme-toggle-effect-polygon-gradient
```
