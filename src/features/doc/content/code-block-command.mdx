...
<ComponentPreview
  ...
  openInV0Url="https://jaydingulley.com/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @jaydindg/code-block-command
```
...
- [Copy Button](https://jaydingulley.com/components/copy-button)
...
<CodeBlockCommand
  ...
  yarn="yarn dlx shadcn add @jaydindg/code-block-command"
